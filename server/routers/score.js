...
const {fHandleUploadStatus, fGetScoresClassByClassId, checkTargetAddScoreExist, checkTeacherOfVNUId, fAddScoreToScoresTable, fGetScoresByVNUId, fHandleUploadScore, fUpdateStatus } = require("../middleware/score-middleware/score");
