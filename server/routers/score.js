...
const {fGetScoresClassByClassId, checkTargetAddScoreExist, checkTeacherOfVNUId, fAddScoreToScoresTable, fGetScoresByVNUId, fHandleUploadScore } = require("../middleware/score-middleware/score");
